...
def sort_versions_with_api(versions)
    tool_path = '/../../bin/tools/sort_package_versions.py'
...
class Script
    ...
    def process(params)
        ...
        ordered_versions = sort_versions_with_api(versions.join',')
    ...
    def post_insert_check
        sql_query = <<-SQL
            ...
            where
                version_order != version_order_api and
                version_order_api > 0;
            group by package_id;
        SQL
